...
font_width = 6
font_height = 5
font_alphabet = " %'-./0123456789:?abcdefghijklmnopqrstuwxyz"


def font_to_bytearray(width, height, alphabet):
    #      |12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|12345|
    font = """
      ##  #  ##                   #  ###   ###  ####  ####  ## ## #####  #### #####  ###   ###        ####  ####  ####   #### ####  ##### #####  #### ## ##  ####  #### ## ## ##    ## ## ####   ###  ####   ###  ####   ####  #### ## ## ## ## ## ## ## ## ##### 
         #   ##                  #  ## ##   ##     ##    ## ## ## ##    ##       ## ## ## ## ##  ##      ## ## ## ## ## ##    ## ## ##    ##    ##    ## ##   ##    ##  ## ## ##    ##### ## ## ## ## ## ## ## ## ## ## ##      ##  ## ## ## ## ## ## ## ##    ## 
        #          ###          #   ## ##   ##   ###  ####   #### ##### ####    ##   ###   ####        ###  ##### ####  ##    ## ## ####  ##### ## ## #####   ##    ##  ####  ##    ##### ## ## ## ## ####  ## ## ####  ####    ##  ## ## ## ##  ###  #####  ###  
...
if __name__ == "__main__":
    ...
    print(
        'data = bytearray(b"{}")'.format("".join("\\x{:02x}".format(x) for x in data))
    )
    print("")
    print("/* Computed with pixelfont.py */")
    ...
    print(
        'static unsigned char font_data[] = "{}";'.format(
            "".join("\\x{:02x}".format(x) for x in data)
        )
    )
