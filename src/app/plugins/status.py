...
class StatusPlugin(BasePlugin):
    ...
    STATUS_WIFI_POSITION = (31, 0)
    STATUS_MQTT_COLOR = dict(r=255, g=255, b=0)
    STATUS_MQTT_POSITION = (31, 1)
    ...
    async def render_status(self):
        ...
        color_off = (0, 0, 0)
        color_wifi = rgb_dict_to_tuple(self.STATUS_WIFI_COLOR) if wifi else color_off
        color_mqtt = rgb_dict_to_tuple(self.STATUS_MQTT_COLOR) if mqtt else color_off
